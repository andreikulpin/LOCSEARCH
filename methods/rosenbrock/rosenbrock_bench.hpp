...
#ifndef ROSENBROCK_BENCH_HPP
#define ROSENBROCK_BENCH_HPP
...
namespace LOCSEARCH {
     ...
     */
    template <typename FT> class RosenbrockBenchMethod : public COMPI::Solver<FT> {
    public:
         ...
         */
        RosenbrockBenchMethod(const COMPI::MPProblem<FT>& prob, FT globMin) : mProblem(prob), 
                mGlobMin(globMin) 
        {
