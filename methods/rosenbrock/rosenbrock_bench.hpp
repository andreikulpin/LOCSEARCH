/* 
 * File:   rosenbrock_method_bench.hpp
 * Author: kulpin
 */

#ifndef ROSENBROCK_METHOD_BENCH_HPP
#define  ROSENBROCK_METHOD_BENCH_HPP
...
namespace LOCSEARCH {
     ...
     */
    template <typename FT> class BenchmarkRosenbrockMethod : public COMPI::Solver<FT> {
    public:
        ...
        struct Options {
             ...
             */
            int maxUnsuccessStepsNumber = 20;
            /**
             * Max steps number
             */
         ...
         */
        BenchmarkRosenbrockMethod(const Benchmark<FT>& prob) :
        mBenchmark(prob) {}
        ...
        bool search(FT* x, FT& v) override {
            ...
            // const snowgoose::Box<double>& box = *(mBenchmark.mBox);
            ...
            auto step = [&] () {
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    xVector.assign(xtmp, xtmp + n);
                    FT ftmp = mBenchmark.calcFunc(xVector);
            ...
            while (!br) {
                ...
                if (!success) { 
                    if (fcur < fOld || unsuccessSteps >= mOptions.maxUnsuccessStepsNumber) {
                        ...
                        // std::cout << "fcur < fOld || unsuccessSteps >= mOptions.maxUnsuccessStepsNumber\n"; 
